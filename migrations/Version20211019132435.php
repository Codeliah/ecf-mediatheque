 ...
 */
final class Version20211019132435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, author VARCHAR(255) NOT NULL COLLATE BINARY, publication_date DATE NOT NULL, description CLOB NOT NULL COLLATE BINARY, genre VARCHAR(255) NOT NULL COLLATE BINARY, isbn INTEGER NOT NULL, cover VARCHAR(255) NOT NULL)');
